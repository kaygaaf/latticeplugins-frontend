...
export const blogGuideCards: BlogGuideCard[] = [
  {
    ...
    description:
      "A buyer-intent guide for bookkeepers and accountants who need cleaner WooCommerce invoice exports, VAT/BTW evidence, PDF links, credit-note relationships, and accountant-ready handoff.",
    theme: "indigo",
  },
  {
    href: "/blog/woocommerce-veterinary-clinic-invoices",
    eyebrow: "Veterinary clinic invoices",
    title: "WooCommerce veterinary clinic invoices: insurance, VAT, and PDFs",
    description:
      "A buyer-intent guide for veterinary clinics, animal hospitals, pet pharmacies, and pet-care stores that need pet/insurance metadata, VAT invoice PDFs, deposits, refunds, credit notes, and accountant export.",
    theme: "teal",
  },
  {
    ...
    description:
      "A buyer-intent guide for preorder, backorder, launch, and reservation stores that need VAT-ready proformas, final invoices, deposit/balance fields, customer PDFs, refunds, and credit notes.",
    theme: "emerald",
  },
  {
  ...
  },
  {
    ...
    description:
      "A buyer-intent guide for dropshipping stores that need VAT fields, seller-of-record clarity, supplier references, tracking evidence, customer PDFs, refunds, credit notes, and accountant export.",
    theme: "emerald",
  },
  {
    href: "/blog/woocommerce-manufacturing-parts-invoices",
    eyebrow: "Manufacturing parts invoices",
    title: "WooCommerce manufacturing parts invoices: PO, VAT, and PDFs",
    description:
      "A buyer-intent guide for manufacturers, spare-parts sellers, and industrial suppliers that need PO references, serial numbers, VAT fields, invoice PDFs, credit notes, and accountant export.",
    theme: "cyan",
  },
  {

...
export const metadata: Metadata = {
  ...
  description:
    "A buyer-intent guide for WooCommerce stores using PayPal that need VAT/BTW checkout fields, paid invoice PDFs, refund credit notes, PayPal transaction evidence, and accountant-ready exports.",
  alternates: {
    canonical: `${SITE_URL}/blog/woocommerce-paypal-invoice-workflow`,
  },
  openGraph: {
    title: "WooCommerce PayPal invoice workflow for EU VAT stores",
    description:
      "Map PayPal payment events to WooCommerce invoice PDFs, VAT metadata, refund credit notes, customer downloads, and accounting evidence before buying an invoice plugin.",
    url: `${SITE_URL}/blog/woocommerce-paypal-invoice-workflow`,
...
const readinessChecklist = [
  {
    title: "1. Capture VAT/BTW data before PayPal payment",
    detail:
    ...
    buyerQuestion: "Does the invoice workflow store VAT fields on the WooCommerce order before final invoice creation?",
  },
  {
...
const scenarios = [
  ...
  },
  {
    ...
    workflow:
      "Require invoice-ready business metadata before final invoice creation and keep PayPal payment evidence beside VAT totals and invoice PDF status.",
  },
  {
    title: "Partial or full PayPal refund",
    trigger: "A paid order is refunded in WooCommerce or PayPal and accounting asks for the VAT correction trail.",
    workflow:
      "Retain the original invoice, create a linked credit note, store the PayPal refund transaction reference, and export both documents together.",
  },
];

const comparisonRows = [
  {
    weak: "PayPal dashboard has the payment, WooCommerce has the order, invoice PDF is a separate manual step.",
    strong: "WooCommerce order links invoice number, PDF, PayPal transaction/refund references, VAT fields, and customer download status.",
  },
  {
  ...
  },
  {
    ...
    strong: "Refund workflow creates credit-note evidence linked to the original invoice and PayPal refund.",
  },
  {
    weak: "Customers email support for missing invoices after PayPal payments.",
...
const faq = [
  {
    q: "Does PayPal automatically solve WooCommerce VAT invoicing?",
    a: "No. PayPal handles payment collection and payment evidence. EU VAT invoices still need WooCommerce order metadata, invoice numbers, VAT fields, PDF delivery, refund credit notes, and accountant-ready exports.",
  },
  {
    q: "When should a PayPal-paid WooCommerce invoice be created?",
    a: "Usually when the order reaches the store's paid status, such as processing or completed. Creating the final invoice before PayPal payment succeeds can create invoice-number gaps and support confusion.",
  },
  {
    q: "How should PayPal refunds appear in invoice records?",
    a: "The original invoice should remain retained. Refunds should create credit-note or correction evidence linked to the WooCommerce order, PayPal refund transaction, VAT totals, and customer-facing PDF history.",
  },
  {
    q: "Where does Lattice fit if I already use a PayPal gateway?",
    a: "Your PayPal gateway focuses on the payment path, while the Lattice Invoices early-access workflow focuses on VAT/BTW invoice evidence, PDF delivery, credit notes, and accounting handoff after payment.",
  },
];
...
const articleSchema = {
  ...
  "@type": "Article",
  headline: "WooCommerce PayPal invoice workflow for EU VAT stores",
  description:
    "A practical buyer guide for WooCommerce stores using PayPal that need VAT checkout fields, paid invoice PDFs, refund credit notes, customer downloads, and accountant-ready exports.",
  mainEntityOfPage: `${SITE_URL}/blog/woocommerce-paypal-invoice-workflow`,
  publisher: {
    "@type": "Organization",
...
const mailto =
  "mailto:support@latticeplugins.com?subject=WooCommerce%20PayPal%20invoice%20workflow%20review&body=Hi%20Lattice%2C%0A%0AI%20want%20a%20WooCommerce%20PayPal%20invoice%20workflow%20review.%0A%0AStore%20URL%3A%20%0ACountry%3A%20%0APayPal%20gateway%3A%20%0ACurrent%20invoice%20plugin%3A%20%0AVAT%2FBTW%20fields%20needed%3A%20%0ARefund%2Fcredit-note%20workflow%3A%20%0AAccounting%20export%20needs%3A%20";

export default function WooCommercePayPalInvoiceWorkflowPage() {
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-900 text-white">
        <div className="max-w-5xl mx-auto px-6 py-16 lg:py-20">
          <p className="uppercase tracking-[0.3em] text-sm text-blue-200 mb-4">WooCommerce PayPal invoicing</p>
          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
            WooCommerce PayPal invoices without VAT gaps, refund confusion, or support tickets.
          </h1>
          <p className="text-xl text-blue-50 leading-relaxed max-w-3xl mb-8">
            PayPal makes checkout familiar. EU stores still need invoice-ready WooCommerce data: VAT/BTW fields, final invoice numbers, PayPal transaction evidence, refund credit notes, customer downloads, and accounting exports. Use this checklist before buying or replacing an invoice plugin.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <a href={mailto} className="bg-green-400 text-slate-950 px-8 py-4 rounded-xl font-semibold hover:bg-green-300 transition shadow-lg text-center">
              Request €49 PayPal invoice workflow review
            </a>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <article className="lg:col-span-2 space-y-8">
            <div className="bg-white rounded-2xl border shadow-sm p-8">
              <h2 className="text-3xl font-bold mb-4">Why PayPal stores still need an invoice workflow</h2>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-2xl p-8">
              <h2 className="text-3xl font-bold mb-5">PayPal invoice readiness checklist</h2>
            ...
            <div className="bg-white rounded-2xl border shadow-sm p-8">
              <h2 className="text-3xl font-bold mb-5">Three PayPal invoice scenarios to test</h2>
            ...
            <div className="bg-slate-900 text-white rounded-2xl p-8">
              <h2 className="text-3xl font-bold mb-4">What to send for a PayPal invoice review</h2>
          ...
          <aside className="space-y-6">
            <div className="bg-white rounded-2xl border shadow-sm p-6 sticky top-6">
              ...
              <h2 className="text-2xl font-bold mb-3">Turn PayPal payment evidence into invoice evidence.</h2>
              ...
              <Link href="/product/lattice-commerce-suite" className="block border border-slate-200 px-5 py-3 rounded-xl font-semibold text-center hover:border-blue-500 hover:text-blue-600 transition mb-3">
                View Lattice Commerce Suite
              </Link>

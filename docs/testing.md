...
```text
[chromium] › blog.spec.ts:8:5 › blog page shows curated invoice guides without default starter posts
[chromium] › blog.spec.ts:23:5 › blog guide cards match the curated source-of-truth set
